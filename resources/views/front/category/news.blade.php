        ...
        <div class="row m0 blog_row">
            <div class="col-sm-8 main_blog">
                ...
                @foreach($data as $post)
                    <div class="blog_content" style="background:#fff;padding: 5px 15px;margin-bottom:10px;">
                    ...
                    <div class="cat-content-body" style="padding:10px;">
                        <div class="col-sm-6">
                            <a href="{{route('getPostBySlug', $post->slug) }}" style="text-decoration:none">
                ...
                @endforeach
                @else
                    <div class="alert alert-warning text-center"><h5>{{ trans('app.no_news') }}</h5></div>
                @endif
            </div>
            </div>
