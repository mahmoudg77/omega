...
@section('content')
    ...
    <section class="slider_area row m0">
        <div class="slider_inner">
            @foreach(App\Models\Post::where('post_type_id',4)->get() as $slide )
            <div data-thumb="{{$slide->mainImage()}}" data-src="{{$slide->mainImage()}}">
                <div class="camera_caption">
                   <div class="container">
                        <h5 class=" wow fadeInUp animated">Welcome to our</h5>
                        <h3 class=" wow fadeInUp animated" data-wow-delay="0.5s">{{$slide->title}}</h3>
                        <p class=" wow fadeInUp animated" data-wow-delay="0.8s">{!! str_limit($slide->body, 100,"") !!}</p>
                        <a class=" wow fadeInUp animated" data-wow-delay="1s" href="{{route('getPostBySlug',$slide->slug)}}">Read More</a>
                   </div>
                </div>
            </div>
            @endforeach
