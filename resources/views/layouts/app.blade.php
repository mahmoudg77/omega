            ...
            <div class="footer_row row">
                ...
                <div class="col-md-3 col-sm-6 footer_about">
                    ...
                    <address>
                        ...
                        <ul class="my_address">
                            <li><a href="#"><i class="fa fa-envelope" aria-hidden="true"></i>info@omegaegy.net</a></li>
                            <li><a href="#"><i class="fa fa-phone" aria-hidden="true"></i>+202 2795 1402</a></li>
                            <li><a href="#"><i class="fa fa-map-marker" aria-hidden="true"></i><span>17 Magles El Shaab St. Lazogly Square Cairo, Egypt </span></a></li>
                        </ul>
                    </address>
                </div>
            </div>
